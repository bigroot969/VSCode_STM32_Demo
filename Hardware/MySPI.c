...
void MySPI1_Init(void)
{
	...
	SPI_InitStruct.SPI_BaudRatePrescaler = SPI_BaudRatePrescaler_4; // 72MHz/8=9MHz（符合 ST7735S 上限）
...
void MySPI2_Init(void)
{
	...
	SPI_InitStructure.SPI_BaudRatePrescaler = SPI_BaudRatePrescaler_2; // 波特率分频，选择2分频 (36MHz/2 = 18MHz)
